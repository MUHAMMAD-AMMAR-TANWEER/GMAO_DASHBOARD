...
const Ecommerce = () => {
  ...
  const [remainingData2, setRemainingData2] = useState();
  ...
  const Data2 = async (startDate, endDate) => {
    const response = await axios.get(
  ...
  useEffect(() => {
    (async () => {
      if (startDate && endDate) {
        console.log(startDate, endDate, "console please table data");
        // BarData(startDate, endDate)
        let fetchBarData = await Data(startDate, endDate);
        console.log(startDate, endDate, "Faizan");
        setTableData(fetchBarData);
        let fetchBarData2 = await Data2(startDate, endDate);
        console.log(startDate, endDate, "Faizan");
        setTableData(fetchBarData2);
        // setDisplayBtn(false);
        ...
        <div className="flex flex-col flex-wrap lg:flex-nowrap justify-center ">
          ...
          <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
            <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              ...
              {totalData ?
                <p className="mt-3">
                <span className=" flex justify-center text-xl font-bold">{totalData}</span>
              </p>:
              <img className="flex justify-center ml-20 " style={{height: "25px"}} src={loader} alt="loader" />
            }
            ...
            <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              ...
              {completedData ?
                <p className="mt-3">
                <span className=" flex justify-center text-xl font-bold">{completedData}</span>
              </p>:
              <img className="flex justify-center ml-20 " style={{height: "25px"}} src={loader} alt="loader" />
            }
            </div>
            <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              ...
              {remainingData ?
                <p className="mt-3">
                <span className=" flex justify-center text-xl font-bold">{remainingData}</span>
              </p>:
              <img className="flex justify-center ml-20 " style={{height: "25px"}} src={loader} alt="loader" />
            }
            </div>
        ...
        <div className="flex flex-col flex-wrap lg:flex-nowrap justify-center ">
          ...
          <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
            <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              ...
              {totalData2 ?
                <p className="mt-3">
                <span className=" flex justify-center text-xl font-bold">{totalData2}</span>
              </p>:
              <img className="flex justify-center ml-20 " style={{height: "25px"}} src={loader} alt="loader" />
            }
            </div>
            <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              ...
              {completedData2 ?
                <p className="mt-3">
                <span className=" flex justify-center text-xl font-bold">{completedData2}</span>
              </p>:
              <img className="flex justify-center ml-20 " style={{height: "25px"}} src={loader} alt="loader" />
            }
            </div>
            <div className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              ...
              {remainingData2 ?
                <p className="mt-3">
                <span className=" flex justify-center text-xl font-bold">{remainingData2}</span>
              </p>:
              <img className="flex justify-center ml-20 " style={{height: "25px"}} src={loader} alt="loader" />
            }
            </div>
